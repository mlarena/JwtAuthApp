...
{
    [Authorize]
    public class IWSDataController : Controller
    {
        private readonly ApplicationDbContext _context;

        public IWSDataController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var item = await _context.IWSDatas
                .AsNoTracking()
                .Include(d => d.Sensor)
