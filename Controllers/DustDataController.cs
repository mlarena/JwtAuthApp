...
{
    [Authorize]
    public class DustDataController : Controller
    {
        private readonly ApplicationDbContext _context;

        public DustDataController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var item = await _context.DustDatas
                .AsNoTracking()
                .Include(d => d.Sensor)
