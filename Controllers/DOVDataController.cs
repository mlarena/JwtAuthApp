...
{
    [Authorize]
    public class DOVDataController : Controller
    {
        private readonly ApplicationDbContext _context;

        public DOVDataController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var item = await _context.DOVDatas
                .AsNoTracking()
                .Include(d => d.Sensor)
