...
{
    [Authorize]
    public class MUEKSDataController : Controller
    {
        private readonly ApplicationDbContext _context;

        public MUEKSDataController(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            var item = await _context.MUEKSDatas
                .AsNoTracking()
                .Include(d => d.Sensor)
